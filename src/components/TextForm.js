    ...
    <>
        <div style={{color:props.mode=='dark'?'white':'black' }} >
            ...
            <div className="mb-3">
                ...
                <textarea className="form-control" value={text} style={{backgroundColor: props.mode=='light'?'white':'#13466e',color:props.mode=='dark'?'white':'black'}} onChange={handleOnChange} id="myBox" rows="8"></textarea>
            </div>
        ...
        <div className="container my-3" style={{color:props.mode=='dark'?'white':'black'}}>
            ...
            <p>{0.08*text.split(" ").filter((element)=>{return element.length!==0}).length} Minutes to read this content </p>
            <h2>Preview</h2>
